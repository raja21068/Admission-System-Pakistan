...
public final class JRViewer300 extends javax.swing.JPanel implements JRHyperlinkListener {
    ...
    protected ReportFilterProvider filter;
    protected admission.xmlparser.Report report;
    protected admission.reports.ReportFilterDialog reportFilterDialog;
    ...
    public void loadJasperReport(JasperPrint jrPrint) {
        loadReport(jrPrint);
     ...
     * Yougesh
     */
    public void setReportFilterObject(ReportFilterProvider filter, admission.xmlparser.Report report, admission.reports.ReportFilterDialog reportFilterDialog) {
        this.filter = filter;
        this.report = report;
        this.reportFilterDialog = reportFilterDialog;
    }
...
// JG Jul 2012 Added Docx Contributor
    ...
    private void initComponents() {
        ...
        btnReportFilter = new javax.swing.JButton();
        ...
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Media-Floppy-16.png"))); // NOI18N
        ...
        btnPrint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Document-Print-16.png"))); // NOI18N
        ...
        btnActualSize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Zoom-Original-16.png"))); // NOI18N
        ...
        btnFitPage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Zoom-Fit-Best-16.png"))); // NOI18N
        ...
        btnFitWidth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Actions-zoom-fit-width-icon16.png"))); // NOI18N
        ...
        btnReportFilter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/filter16.png"))); // NOI18N
        btnReportFilter.setToolTipText("Report Filter");
        btnReportFilter.setFocusable(false);
        btnReportFilter.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnReportFilter.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnReportFilter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnReportFilterActionPerformed(evt);
            }
        });
        jToolBar1.add(btnReportFilter);

        btnReload.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-View-Refresh-16.png"))); // NOI18N
        ...
        btnZoomIn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Zoom-In-16.png"))); // NOI18N
        ...
        cmbZoom.setMaximumSize(new java.awt.Dimension(80, 27));
        cmbZoom.setMinimumSize(new java.awt.Dimension(80, 27));
        cmbZoom.setPreferredSize(new java.awt.Dimension(80, 27));
        ...
        btnZoomOut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Zoom-Out-16.png"))); // NOI18N
        ...
        btnFirst.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Go-First-16.png"))); // NOI18N
        ...
        btnPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Go-Previous-16.png"))); // NOI18N
        ...
        txtGoTo.setMaximumSize(new java.awt.Dimension(40, 27));
        txtGoTo.setMinimumSize(new java.awt.Dimension(40, 27));
        txtGoTo.setPreferredSize(new java.awt.Dimension(40, 27));
        ...
        btnNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Go-Next-16.png"))); // NOI18N
        ...
        btnLast.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Gnome-Go-Last-16.png"))); // NOI18N
	...
	void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
            ...
            if (retValue == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    admission.utils.MessageBox.info(this, getBundleString("error.saving"));
                }
            }
                    ...
                    new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                admission.utils.MessageBox.info(JRViewer300.this, getBundleString("error.printing"));
                            } finally {
...
//                    refreshPage();
//
//                    utilities.MessageBox.info(this, getBundleString("error.loading"));
//                }
//
//                forceRefresh();
//            }
//            if(this.reportFilterDialog)
            reportFilterDialog.setReport(report);
            reportFilterDialog.setFilter(filter, this);
            reportFilterDialog.executeReport(evt);
    ...
    private void btnReportFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportFilterActionPerformed
        // TODO add your handling code here:
        reportFilterDialog.setReport(report);
        reportFilterDialog.showFilter(filter, this);
    }//GEN-LAST:event_btnReportFilterActionPerformed
    ...
    protected void hyperlinkClicked(JRPrintHyperlink hyperlink) {
        try {
            ...
            admission.utils.MessageBox.info(this, getBundleString("error.hyperlink"));
        }
    }
...
//            btnReportFilter.setEnabled(false);
//            btnReload.setEnabled(false);

            if (jasperPrint != null) {
                admission.utils.MessageBox.info(this, getBundleString("no.pages"));
            }
...
//        btnReportFilter.setEnabled(true);
//        btnReload.setEnabled(true);
    ...
    protected void setPageImage() {
        ...
        if (pageError) {
            ...
            try {
                ...
                image = getPageErrorImage();
                admission.utils.MessageBox.info(this, java.util.ResourceBundle.getBundle("net/sf/jasperreports/view/viewer").getString("error.displaying"));
            }
        }
    ...
    protected void paintPage(Graphics2D grx) {
        ...
        try {
            ...
            SwingUtilities.invokeLater(new Runnable() {
                @Override
                public void run() {
                    admission.utils.MessageBox.info(JRViewer300.this, getBundleString("error.displaying"));
                }
            });
        }
    ...
    protected javax.swing.JButton btnReportFilter;
