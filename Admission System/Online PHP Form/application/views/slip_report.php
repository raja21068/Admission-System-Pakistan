...
class Slip_Report
{
    ...
    public function printReport($bean,$campusList,$group_name)
    {
        ...
        $pd->Cell(0,$heightCell,$bean->getFathersName(),0,1);
        ...
        $current_x = $pd->GetX();
        $pd->SetFont("Times",'',7);
        $pd->Cell(86,$heightCell,$bean->getPostalAddr(),0,1);
        ...
        $pd->Image($this->candidateImage,($widthCell+$lmargin),($top_margin+$tmargin-10),$picture_width,48);
