            ...
            <div class='col-md-10'>
                ...
                <div class="col-md-6 ">
                    <div class="form-group">
                        <div class="form-group" >
                            <label > Apply For </font> <font color="red">*</font></label>
                            <select class="form-control chosen-select"  style="font-size: large;" name="<?php echo Variable::PROGRAM_TYPE()?>"  required="required">
              
						<option value="">--Choose--</option>
						<?php if($candidate_bean->getProgramTypeId() == 1){ ?>
                        ...
                        <div class="form-group">
                            <label for="pwd">Name<font color="red">* (According to Matriculation Certificate)</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Father's Name<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" pattern="([ a-zA-Z]){3,120}" title="Only Alphabets minimum 3 characters" name="<?php echo Variable::$SURNAME?>" value="<?php echo $candidate_bean->getSurname(); ?>" >
                        </div>
                        <div class="form-group">
                            <label for="pwd">Gender<font color="red">*</font></label>
                            <div class="form-control">
                                <label class="radio-inline">
                        ...
                        <div class="form-group">
                            <label for="pwd">CNIC No. of applicant (or Father<span>'</span>s CNIC #  if applicant is below 18 yrs)<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Date of Birth<font color="red">* (According to Matriculation Certificate)</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Religion<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Nationality<font color="red">*</font></label>
                            <select class="form-control chosen-select"  id="country" name="<?php echo Variable::$COUNTRY?>" required>
                                <option value="" >--Choose--</option>
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <label for="pwd">District of Domicile</label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Urban/Rural<font color="red">*</font></label>
                            <div class="form-control">
                                <label class="radio-inline">
                        ...
                        <div class="form-group">
                            <label for="pwd">Same As Above</label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Guardian Name<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Relationship with Guardian<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Occupation of Father/Guardian<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Guardian<span>'</span>s Mobile Number</label>
                        ...
                        <div class="form-group">
                            ...
                            <label for="pwd">Guardian Address<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Form Serial No <font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">HBL Branch. <font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Challan No. <font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Challan Date<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="pwd">Picture (Please upload your  recent passport size photograph with white background)</label>
